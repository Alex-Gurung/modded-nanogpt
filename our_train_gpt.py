...
if master_process:
    # Build a machine-readable config snapshot for the agent.
    # This will be parsed by open.py into the experiment history.
    hp_info = {
    ...
    print0("HP_CONFIG_JSON " + json.dumps(hp_info))
...
print0(
    f"BENCH_RESULT time_seconds={training_time_ms/1000:.3f} best_val_loss={val_loss:.4f}",
    console=True,
)


dist.destroy_process_group()
# near the end of training, when you compute the final timing / best val loss
